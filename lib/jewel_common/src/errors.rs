...
pub enum ErrorCode {
    ...
    #[msg("vault doesnt't containt any jewels")]
    VaultIsEmpty,

    #[msg("this jewel is not present on any of the whitelists")]
    NotWhitelisted,
    ...
    #[msg("wrong metadata account, jewel mint doesn't match")]
    WrongMetadata,

    #[msg("max farmer count exceeded")]
    TooManyFarmersStaked, //0x17a0

    #[msg("max jewels exceeded")]
    TooManyJewelsStaked, //0x17a1
