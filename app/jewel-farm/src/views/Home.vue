<template>
  <div class="nes-container with-title mb-10">
    ...
    <p>Welcome to Jewel Farm 💎 - the #1 NFT Staking solution on Solana!</p>
    <p class="mt-5">
    ...
    <p class="mt-5">
      ...
      <a class="text-blue-600" href="https://docs.jewelworks.gg/" target="_blank"
        >here</a
      >.
    </p>
    <p class="mt-5">
      Jewel Farm is deployed at:
      <span class="bg-yellow-100">{{ JEWEL_FARM_PROG_ID }}</span>
    </p>
  </div>
...
import { JEWEL_FARM_PROG_ID } from '@jewelworks/jewel-farm-ts';
