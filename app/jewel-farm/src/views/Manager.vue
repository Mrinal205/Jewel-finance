...
import TestMint from '@/components/jewel-farm/TestMint.vue';
import { initJewelFarm } from '@/common/jewel-farm';
import InitFarm from '@/components/jewel-farm/InitFarm.vue';
import { PublicKey } from '@solana/web3.js';
import { stringifyPKsAndBNs } from '@jewelworks/jewel-farm-ts';
import AuthorizeFunder from '@/components/jewel-farm/AuthorizeFunder.vue';
import FundCancelLock from '@/components/jewel-farm/FundCancelLock.vue';
import RefreshFarmer from '@/components/jewel-farm/RefreshFarmer.vue';
import TreasuryPayout from '@/components/jewel-farm/TreasuryPayout.vue';
import TheWhitelist from '@/components/jewel-farm/BankWhitelist.vue';
import UpdateFarm from '@/components/jewel-farm/UpdateFarm.vue';
import FarmDisplay from '@/components/jewel-farm/FarmDisplay.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    watch([wallet, cluster], async () => {
      gf = await initJewelFarm(getConnection(), getWallet()!);
