      ...
      <div v-if="activeRewardType === 'fixed'">
        <div class="flex mb-5">
          <div class="nes-field mr-5 flex-1">
            <label for="baseRate">Base rate (tokens/jewel/s):</label>
            <input
              id="baseRate"
              type="text"
              class="nes-input"
        ...
        <div class="flex mb-5">
          <div class="nes-field mr-5 flex-1">
            <label for="t1RewardRate">Tier 1 reward rate (tokens/jewel/s):</label>
            <input
              id="t1RewardRate"
              type="text"
              class="nes-input"
        ...
        <div class="flex mb-5">
          <div class="nes-field mr-5 flex-1">
            <label for="t2RewardRate">Tier 2 reward rate (tokens/jewel/s):</label>
            <input
              id="t2RewardRate"
              type="text"
              class="nes-input"
        ...
        <div class="flex mb-5">
          <div class="nes-field mr-5 flex-1">
            <label for="t3RewardRate">Tier 3 reward rate (tokens/jewel/s):</label>
            <input
              id="t3RewardRate"
              type="text"
              class="nes-input"
