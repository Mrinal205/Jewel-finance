<template>
  <div>
    <div class="mb-2">Base rate: {{ schedule.baseRate }} tokens/jewel/s</div>
    <div class="mb-2" v-if="schedule.tier1">
      T1 reward rate:
      {{ schedule.tier1.rewardRate }} tokens/jewel/s
    </div>
    <div class="mb-2" v-if="schedule.tier1">
      T1 required tenure:
    ...
    <div class="mb-2" v-if="schedule.tier2">
      T2 reward rate:
      {{ schedule.tier2.rewardRate }} tokens/jewel/s
    </div>
    <div class="mb-2" v-if="schedule.tier2">
      T2 required tenure:
    ...
    <div class="mb-2" v-if="schedule.tier3">
      T3 reward rate:
      {{ schedule.tier3.rewardRate }} tokens/jewel/s
    </div>
    <div class="mb-2" v-if="schedule.tier3">
      T3 required tenure:
